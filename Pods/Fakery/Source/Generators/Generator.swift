...
public class Generator {
  ...
  public struct Constants {
    public static let uppercaseLetters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".characters.map { String($0) }
    public static let letters = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".characters.map { String($0) }
    public static let numbers = "0123456789".characters.map { String($0) }
  }
